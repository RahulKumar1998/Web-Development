...
<a href="#" class="btn btn-primary logb" data-toggle="modal" data-target="#myModal"> <span aria-hidden="true"></span>&nbsp;<span class="title1"><b> Login </b> </span></a></div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="rollno" name="rollno" placeholder="Enter your USN" class="form-control input-md" type="text" value="<?php
...
<div class="col-md-2 box">
<a href="about.php" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">About Developers</a></div>
</div>
